...
public class CDVBackgroundGeolocation extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
        ...
        if (ACTION_START.equalsIgnoreCase(action)) {
        ...
        } else if (ACTION_START_GEOFENCES.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_REMOVE_LISTENER.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_SET_ODOMETER.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_ADD_GEOFENCES.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_REMOVE_GEOFENCES.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_GET_GEOFENCE.equalsIgnoreCase(action)) {
            result = true;
            getGeofence(data.getString(0), callbackContext);
        } else if (ACTION_GEOFENCE_EXISTS.equalsIgnoreCase(action)) {
            result = true;
            ...
            callbackContext.success();
        } else if (ACTION_GET_CURRENT_POSITION.equalsIgnoreCase(action)) {
            result = true;
            getCurrentPosition(callbackContext, data.getJSONObject(0));
        } else if (ACTION_WATCH_POSITION.equalsIgnoreCase(action)) {
            result = true;
            watchPosition(callbackContext, data.getJSONObject(0));
        } else if (ACTION_STOP_WATCH_POSITION.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_DESTROY_LOCATIONS.equalsIgnoreCase(action)) {
            result = true;
            destroyLocations(callbackContext);
        } else if (ACTION_DESTROY_LOCATION.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_INSERT_LOCATION.equalsIgnoreCase(action)) {
            result = true;
            insertLocation(data.getJSONObject(0), callbackContext);
        } else if (ACTION_GET_COUNT.equalsIgnoreCase(action)) {
            result = true;
            getCount(callbackContext);
        } else if (ACTION_DESTROY_LOG.equalsIgnoreCase(action)) {
            result = true;
            destroyLog(callbackContext);
        } else if (ACTION_GET_SENSORS.equalsIgnoreCase(action)) {
            result = true;
            getSensors(callbackContext);
        } else if (DeviceInfo.ACTION_GET_DEVICE_INFO.equalsIgnoreCase(action)) {
            result = true;
            getDeviceInfo(callbackContext);
        } else if (ACTION_IS_POWER_SAVE_MODE.equalsIgnoreCase(action)) {
            result = true;
            isPowerSaveMode(callbackContext);
        } else if (ACTION_IS_IGNORING_BATTERY_OPTIMIZATIONS.equalsIgnoreCase(action)) {
            result = true;
        ...
        } else if (ACTION_GET_PROVIDER_STATE.equalsIgnoreCase(action)) {
            result = true;
            getProviderState(callbackContext);
        } else if (ACTION_REQUEST_PERMISSION.equalsIgnoreCase(action)) {
            result = true;
