...
#ifndef TSLOCATIONMANAGER_SWIFT_H
#define TSLOCATIONMANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TSLocationManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSData;
SWIFT_CLASS_NAMED("TSEd25519VerifierSwift")
@interface TSLMSwiftVerifier : NSObject
/// Obj-C selector: verifyWithMessage:signature:publicKey:
+ (BOOL)verifyWithMessage:(NSData * _Nonnull)message signature:(NSData * _Nonnull)sig publicKey:(NSData * _Nonnull)pub SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_EXTERN void TSLMSwiftPing(void) SWIFT_NOEXCEPT;
